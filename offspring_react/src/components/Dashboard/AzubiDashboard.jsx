...
const AzubiDashboard = () => {
  ...
  return <div className="container mx-auto p-4 object-center w-200">
      <h1 className="mb-4 text-lg font-extrabold text-gray-900 dark:text-white md:text-2xl lg:text-4xl">
        <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">
          Offspring.
        </span>{" "}
        Nachwuchs.
      </h1>
      <p className="font-normal text-gray-500 lg:text-xl dark:text-gray-400">
        ...
        dem richtigen Weg zu bleiben. So profitierst du von einer strukturierten
        und transparenten Dokumentation, die deinen Fortschritt unterstützt, um
        Deine Ausbildung bestmöglich zu meistern.{" "}
      </p>
